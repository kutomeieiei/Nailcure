...
import { Activity, ArrowRight, ShieldAlert, HeartPulse, BookOpen } from 'lucide-react';
...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate, lang }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 md:py-20">
      ...
      {/* Info Box Section 2 */}
      <div className="max-w-5xl mx-auto bg-white rounded-3xl p-8 border border-gray-100 flex flex-col md:flex-row-reverse items-center gap-8 mb-4 shadow-lg hover:shadow-xl transition-shadow duration-300 animate-slide-up delay-200">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-4">
      ...
      <div className="max-w-5xl mx-auto flex justify-end mb-16 animate-slide-up delay-300">
        <Button 
          variant="outline" 
      ...
      <div className="max-w-2xl mx-auto animate-slide-up delay-400">
        <div 
